...
**FY7 — Bug 1: nation follows were silently suppressed for bilateral matches, which is most international cricket**
...
**FY8 — Bug 2: qualifying live matches duplicated the live carousel instead of reusing it**
...
**FY10 — Gap 2: confirmed zero-current-match follows behave correctly for every category, not just series/tournament**
